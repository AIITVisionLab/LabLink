...
![登录界面](https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=lab%20management%20system%20login%20interface%20with%20modern%20design%2C%20clean%20layout%2C%20blue%20gradient%20background%2C%20login%20form%20with%20username%20and%20password%20fields&image_size=square)

### 5.2 管理员工作台

![管理员工作台](https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=admin%20dashboard%20for%20lab%20management%20system%2C%20with%20metrics%20cards%2C%20pending%20approvals%2C%20recent%20activities%2C%20modern%20UI%20design&image_size=landscape_16_9)

### 5.3 实验室管理界面

![实验室管理界面](https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=lab%20management%20interface%20with%20lab%20list%2C%20search%20functionality%2C%20create%20button%2C%20modern%20table%20design%2C%20status%20tags&image_size=landscape_16_9)

### 5.4 考勤管理界面

![考勤管理界面](https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=attendance%20management%20interface%20with%20attendance%20list%2C%20create%20attendance%20button%2C%20status%20indicators%2C%20modern%20UI%20design&image_size=landscape_16_9)

### 5.5 统计分析界面

![统计分析界面](https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=statistics%20dashboard%20for%20lab%20management%20system%2C%20with%20metrics%20cards%2C%20line%20charts%2C%20date%20picker%2C%20modern%20UI%20design&image_size=landscape_16_9)
