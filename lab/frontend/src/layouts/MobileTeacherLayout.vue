<template>
  <div class="m-shell">
    ...
    <nav class="m-tabbar" aria-label="教师端导航">
      <button
...
<script setup>
import { ArrowLeft, Bell, HomeFilled, User } from '@element-plus/icons-vue'
...
const title = computed(() => route.meta.title || '教师端')
...
const tabItems = [
  { path: '/m/teacher/dashboard', label: '首页', icon: HomeFilled },
